# user-microservice serverless API
The user-microservice project, created with [`aws-serverless-java-container`](https://github.com/awslabs/aws-serverless-java-container).
...
```bash
$ mvn archetype:generate -DartifactId=user-microservice -DarchetypeGroupId=com.amazonaws.serverless.archetypes -DarchetypeArtifactId=aws-serverless-springboot-archetype -DarchetypeVersion=1.4 -DgroupId=com.user.microservice -Dversion=0.0.1 -Dinteractive=false
            ...
            "Outputs": [
                {
                    ...
                    "ExportName": "UserMicroserviceApi",
                    "OutputKey": "UserMicroserviceApi",
